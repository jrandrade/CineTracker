//
//  UpcomingMoviesWebserviceTests.swift
//  CineTrackerTests
//
...
class UpcomingMoviesWebserviceTests: XCTestCase {

    var stubConfiguration: StubWebserviceConfiguration!
    var mockHttpClient: MockHttpClient!
    var sut: UpcomingMoviesWebservice!
    ...
    func test_HttpClientIsInvoked_When_CallingPerformRequest() async throws {
        ...
        XCTAssertEqual(mockHttpClient.invokedPerformGetRequestParameters?.url, URL(string: "www.example.com/3/movie/upcoming"))
    }
