//
//  TopRatedMoviesWebserviceTests.swift
//  CineTrackerTests
//
...
class TopRatedMoviesWebserviceTests: XCTestCase {

    var stubConfiguration: StubWebserviceConfiguration!
    var mockHttpClient: MockHttpClient!
    var sut: TopRatedMoviesWebservice!
    ...
    func test_HttpClientIsInvoked_When_CallingPerformRequest() async throws {
        ...
        XCTAssertEqual(mockHttpClient.invokedPerformGetRequestParameters?.url, URL(string: "www.example.com/3/movie/top_rated"))
    }
