//
//  PopularMoviesWebserviceTests.swift
//  CineTrackerTests
//
...
class PopularMoviesWebserviceTests: XCTestCase {

    var stubConfiguration: StubWebserviceConfiguration!
    var mockHttpClient: MockHttpClient!
    var sut: PopularMoviesWebservice!
    ...
    func test_HttpClientIsInvoked_When_CallingPerformRequest() async throws {
        ...
        XCTAssertEqual(mockHttpClient.invokedPerformGetRequestParameters?.url, URL(string: "www.example.com/3/movie/popular"))
    }
